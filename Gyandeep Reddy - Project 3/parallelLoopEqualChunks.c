/* parallelLoopEqualChunks.c
	...
	threads iterate through equal sized chunks of the index range (cache
	-beneficial when accessing adjacent memory locations).
*
...
*
	...
	- try with different number of threads, e.g.: 2, 3, 4, 6, 8
*/
